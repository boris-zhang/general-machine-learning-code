...
def estimate_normalized_alpha(J, W_m, num_images=30, threshold=170, invert=False, adaptive=False, 
...
def solve_images(J, W_m, alpha, W_init, gamma=1, beta=1, lambda_w=0.005, lambda_i=1, lambda_a=0.01, iters=10):
    '''
