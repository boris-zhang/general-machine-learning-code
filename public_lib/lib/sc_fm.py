...
Description: 模型函数包
Variables: None
Author: https://github.com/zhaozhiyong19890102/Python-Machine-Learning-Algorithm-3.x/tree/master/Chapter_03%20Factorization%20Machine/code
Change Activity: First coding on 2018/7/30
---------------------------------------------------------------------------
'''
import numpy as np
